...
~~A quick recalculation of the efficiency at 25% maximum output power, or 6-dB-backoff condition, where the voltage and current are half their peak values will reveal that **the efficiency of a Class B amplifier at 6-dB back-off is 19.6%.** This is  better than the 12.5% efficiency at 6-dB backoff from a Class A amplifier. In practice, the output waveform is further engineered to improve efficiency in back-off condition.~~ This whole thing has been re-written on the substack article after 2 hours of consternation!
...
In this article, we will look at a few more conduction angle based classifications, namely Class AB and Class C amplifiers. In contrast to previous posts, we will deal with these classes "loosely" because the more rigorous calculations of efficiency and power back-off are hard to do for arbitrary conduction angles.
...
We'll approach Class AB amplifiers from the perspective of *cross-over distortion* in Class B push-pull amplifiers. 
...
> In Class C operation, the conduction angle is between 0° and 180° (or between 0 and π radians.)

Class C amplifiers have several drawbacks that limit its usefulness at RF frequencies:
